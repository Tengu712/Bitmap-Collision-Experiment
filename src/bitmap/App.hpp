...
private:
  ...
  std::unique_ptr<unsigned char[]> bitmap1;
  std::unique_ptr<unsigned char[]> bitmap2;
...
public:
  ...
  App(size_t entityCount)
    ...
    , bitmap1(std::make_unique<unsigned char[]>(WIDTH* HEIGHT))
    , bitmap2(std::make_unique<unsigned char[]>(WIDTH* HEIGHT))
  {
